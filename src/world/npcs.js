...
const ROSTER = [
  ...
  },
  {
    ...
    lines: [
      ...
      'Matcha polishes that trident every day and has never thrown it once.',
      'Coral trades me potions for arrowheads. Best deal in town.',
      'Between us? Spark once tried to buy a sword with three berries.',
      'A shield is just a door you carry. Think about it.',
    ],
  },
  {
    name: 'Coral',
    ...
    lines: [
      ...
      'Iris helps me pick bottle colours. She refuses to pick just one.',
      'Storm ordered a potion once. He said thanks. I nearly fainted.',
      'Never brew angry. That is how you get exploding fizz.',
      'The Moxolotl? Cosmo swears it hums recipes at night.',
    ],
  },
  {
    name: 'Spark',
    ...
    lines: [
      ...
      'Gold is my best friend! He just does not know it yet.',
      'Wave taught me to skip stones. Mine mostly just... sink loudly.',
      'One day I will out-run Zoom Juice itself!',
      'Matcha let me hold the trident once. BEST. DAY. EVER.',
    ],
  },
  {
    name: 'Bubble',
    ...
    lines: [
      ...
      'Storm and I once watched the kelp together for a whole day. He said one word. Good day.',
      'Pebble gets it. Slow is a speed too.',
      'My brother? No, Bubbles and I are not related. Everyone asks.',
      'The fountain sounds like rain that stays.',
    ],
  },
];
...
ROSTER.push({
  ...
  lines: [
    ...
    'Storms are coming, little Coal. Keep your friends close and your gills flared.',
      ...
      'Matcha guards the village. Storm guards the shore. I guard the hoping.',
      'Coral has my recipes. Light has my lantern heart. All is well kept.',
      'The Moxolotl is not to be feared. It is to be UNDERSTOOD. In time.',
      'Even Storm looks up at this hill sometimes. Do not tell him I noticed.',
    ],
});
...
ROSTER.push({
  ...
  lines: [
    ...
    'Hmph. Tell Hope the clouds say hello.',
      ...
      "Iris keeps painting me 'to add colour'. I keep being black. We are at war.",
      'Bubble is acceptable company. He knows how to be quiet.',
      'Hope waves at me from her hill. Every day. Relentless.',
      'The bow was for hunting. The arrows are for reasons.',
    ],
});
...
ROSTER.push(
  {
    ...
    lines: ['Did someone say swimming?!', 'The fountain is NOT for cannonballs. I checked.', 'Race you around the island! Loser is a land snail.',
      'Wave says he is smoother. SMOOTHER IS NOT FASTER.',
      'Storm splashed me back once. There is hope for that grump.',
      'The pier at the Hunting Point? Best diving board on the island.',
    ],
  },
  {
    name: 'Flame',
    ...
    lines: ['I am not hot-headed. I am warm-spirited.', 'One day I will see the mountain breathe fire. One day.', 'Cold water is a personal insult.',
      'Cosmo says the mountain hums. I say it SNORES. Volcanoes nap.',
      'Splash keeps inviting me swimming. I keep declining. Politely. LOUDLY.',
      'The torches in that cave? Amateur work. Mine would be bigger.',
    ],
  },
  {
    name: 'Iris',
    ...
    lines: ['I could not pick a favourite colour, so I kept them all.', 'Rain plus sun equals ME.', 'Storm says I am too bright. I take that as a compliment.',
      "I painted one of Storm's spines pink while he slept. Worth it.",
      'Coral and I are designing a rainbow potion. It does nothing. It is BEAUTIFUL.',
      'Gold thinks HE shines? Adorable.',
    ],
  },
  {
    name: 'Gold',
    ...
    lines: ['No, I am not made of tokens. Stop biting me, Spark.', 'Shiny on the outside, shinier on the inside.', 'The Gold lotl always pays his debts.',
      'Spark follows me around calling me best friend. ...I have started waving back.',
      'The fish stand haggled me DOWN once. Respect.',
      'Pebble asked if I was a rock. Flattered, honestly.',
    ],
  },
  {
    name: 'Memo',
  ...
  },
  {
    ...
    lines: ['Rocks are just very patient friends.', 'I have named every stone on this beach. That one is Gerald.', 'Slow and steady. Mostly slow.',
      'Gerald the stone met the fountain statue. Big moment for Gerald.',
      'Bubble understands. We sat still together all Tuesday.',
      'The cave boulders are the biggest friends I have ever seen.',
    ],
  },
  {
    name: 'Cosmo',
    ...
    lines: ['The stars visit the island when everyone sleeps.', 'I counted the sky once. I lost my place at forever.', 'The Moxolotl Cave hums at night. Listen.',
      'Light glows on the inside. I count on the outside. We get along.',
      'The Moxolotl hums in B flat. Mostly flat.',
      'Storm is my favourite constellation that walks.',
    ],
  },
  {
    name: 'Spot',
    ...
    lines: ['They call me Spot. Long story. Mad Bao knows.', 'You should see my OTHER spots.', 'I spotted you first. That is how it works.',
      'Mad Bao said the spots CHOOSE the axolotl. I was chosen a LOT.',
      "Memo remembers everyone's name. I remember everyone's spots.",
      'Iris offered to add more colours to me. Tempting. Very tempting.',
    ],
  },
  {
    name: 'Wave',
    ...
    lines: ['The tide goes out. The tide comes back. I respect that.', 'Splash is faster, but I am smoother.', 'Some day I will surf the big storm swell. Do not tell Storm.',
      'Splash races the water. I AM the water. Philosophically.',
      "Storm's beach is the best beach. Do not tell him I said that.",
      'The fish at the pier practically volunteer. Brave little things.',
    ],
  },
  {
    name: 'Light',
    ...
    lines: ['Good morning! It is always morning somewhere.', 'Hope taught me to glow on the inside.', 'Dark caves are just rooms that have not met me yet.',
      'Cosmo counts stars, I keep one in my chest. Teamwork.',
      'I peeked in the Moxolotl cave. The torches waved back!',
      'Hope taught me: glowing is just smiling with extra steps.',
    ],
  },
);
